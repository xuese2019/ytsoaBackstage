...
public interface XmcjService {
    ResponseResult<PageInfo<XmcjModel>> findAll(int pageNow, int pageSize, XmcjModel xmcjModel, String accid) throws Exception;
    ...
    ResponseResult<XmcjModel> updateById(XmcjModel xmcjModel, String accid) throws Exception;
